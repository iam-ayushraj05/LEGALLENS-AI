    ...
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100 font-sans selection:bg-amber-400 selection:text-slate-950">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center relative z-10 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-xl text-sm font-bold bg-amber-400 hover:bg-amber-300 text-slate-950 shadow-lg shadow-amber-500/20 flex items-center justify-center gap-2.5 transition-all transform hover:-translate-y-0.5"
            >
            ...
            <Link
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-xl text-sm font-bold bg-slate-900 hover:bg-slate-800 text-white border border-slate-700 flex items-center justify-center gap-2.5 transition-all shadow-md"
            >
        ...
        <div className="max-w-6xl mx-auto px-4 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-3 relative">
              <span className="text-3xl font-extrabold text-amber-400/40">01</span>
              <h3 className="text-lg font-bold text-white flex items-center gap-2">
                <Upload className="w-5 h-5 text-amber-400" /> Upload
              </h3>
            ...
            {/* Step 2 */}
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-3 relative">
              <span className="text-3xl font-extrabold text-amber-400/40">02</span>
              <h3 className="text-lg font-bold text-white flex items-center gap-2">
                <BookOpen className="w-5 h-5 text-amber-400" /> Understand
              </h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            {/* Step 3 */}
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-3 relative">
              <span className="text-3xl font-extrabold text-amber-400/40">03</span>
              <h3 className="text-lg font-bold text-white flex items-center gap-2">
                <Compass className="w-5 h-5 text-amber-400" /> Explore
              </h3>
              <p className="text-xs text-slate-400 leading-relaxed">
      ...
      <section className="py-20 bg-slate-900/60 border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 space-y-12">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white">Built for clarity, safety, and evidence.</h2>
          </div>
      ...
      <section className="py-16 bg-slate-950 border-b border-slate-800">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold text-white">AI assistance, not legal advice.</h2>
